    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        <ScrollView style={{width:'100%'}}>
          ...
          <Text
            style={{justifyContent:'center', alignSelf:'center', fontSize:30,color:'yellow',margin:50}}>
            REGISTRATION
            </Text>
          <TextInput
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'#ff5722', fontSize:18, fontWeight:'bold',marginLeft:5}}>USERNAME</Text>
          ...
          <Text style={{color:'#ff5722', fontSize:18, fontWeight:'bold',marginLeft:5}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
          ...
          <View style={{alignItems:'center'}}>
            <TouchableOpacity
              ...
              >
              <Text style={{color:'red', fontSize:18, fontWeight:'bold'}}>LOGIN</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={()=>{
